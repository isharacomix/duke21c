...
As an experiment, and in the spirit of the open source movement, we invited our classmates and the Twitter community to join us in considering how Raymond's principles of open software development might translate into open learning. We invited these visitors to join us based on Raymond's suggestion that with the right kind of facilitator to lead them, "many heads are inevitably better than one." Rather than going into the project with clear expectations of what we would find, we envisioned the class as a brainstorming session—an opportunity to think about what we really mean by openness and participation, words that often mean different things to different people.

We thought it was important for the brainstorming session itself to proceed according to open source principles. So, we created this simple Google slideshow, listing each of Raymond's 19 principles on its own slide, then invited our classmates to join us in an annotating the slides. Once class began we also invited the Twitter community to join us in our online brainstorming session (see figures 1 and 2 below). Our tweeting began at 6 pm, and by 6:45 pm, the document was being viewed by people throughout the United States and Europe.1One visitor, the teacher and artist Giulia Forsythe, shared her visual notes on "The Cathedral and the Bazaar," featured at the beginning of our chapter. The topics that came out of this brainstorming session emerged into the chapter you are reading right now. 

Figure 1: We began tweeting links just after 6pm.

Figure 2: By 6:45pm, we had visitors from around the world.
